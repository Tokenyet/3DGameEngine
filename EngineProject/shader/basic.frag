...
void main()
{
	...
	vec3 dirColor = CalcDirLight(norm, viewDir, vec3(currentDiffusePixel) ,specular, shininess);

	// Phase 2: Point lights
	vec3 pointColors = CalcPointLights(norm, FragPos, viewDir, vec3(currentDiffusePixel), specular, shininess);
